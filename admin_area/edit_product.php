               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img width="70" height="70" src="product_images/<?php echo $p_image_2; ?>" alt="<?php echo $p_image_2; ?>">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="product_stock" type="text" class="form-control" required value="<?php echo $p_stock; ?>">
...
if(isset($_POST['update'])){
    ...
    $update_product = "UPDATE product SET category_id='$product_cat',product_name='$product_name',product_img_1='$product_img_1',product_img_2='$product_img_2',product_desc='$product_desc',product_price='$product_price',product_stock='$product_stock' WHERE product_id='$p_id'";
